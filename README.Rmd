...
Creates a scatter plot given two numerical variables. Output can include simple statistics and the plot can provide regression trendline. Spearman and Pearson's correlation will also be returned to aid the user to determining feature relationship.
