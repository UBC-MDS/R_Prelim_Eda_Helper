...
-   Fork the package and clone onto your computer.
    If you haven't done this before, we recommend using `usethis::create_from_github("UBC-MDS/R_Prelim_Eda_Helper", fork = TRUE)`.
...
Please note that the RPrelimEdaHelper project is released with a [Contributor Code of Conduct](CODE_OF_CONDUCT.md).
